...
CREATE POLICY "Public Read Access" ON storage.objects FOR SELECT USING (bucket_id IN ('products', 'bowls', 'toppings', 'sauces', 'banners', 'logos', 'reviews', 'acai-types'));

-- Permitir upload para usuários autenticados
CREATE POLICY "Authenticated Upload" ON storage.objects FOR INSERT WITH CHECK (
  bucket_id IN ('products', 'bowls', 'toppings', 'sauces', 'banners', 'logos', 'reviews', 'acai-types')
